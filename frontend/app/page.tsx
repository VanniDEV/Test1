...
import { BlogList } from './(marketing)/components/blog-list';
import { EbookGrid } from './(marketing)/components/ebook-grid';
import { Hero } from './(marketing)/components/hero';
import { LeadCaptureForm } from './(marketing)/components/lead-capture-form';
import { RagPublisher } from './(marketing)/components/rag-publisher';
import { ServiceList } from './(marketing)/components/service-list';
...
export default async function HomePage() {
  ...
  const hero = page.hero ?? {
    ...
    subtitle:
      'Deploy a branded Next.js front-end with a Django CMS, integrated Zoho CRM, and Retrieval-Augmented Generation for rapid publishing.'
  };
